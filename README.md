...
```bash
bash -c "$(curl -fsSL [https://raw.githubusercontent.com/AlexanderBierton/dotfiles/refs/heads/trunk/setup-git.sh](https://raw.githubusercontent.com/AlexanderBierton/dotfiles/refs/heads/trunk/setup-git.sh))"
```
...
```bash
bash -c "$(curl -fsSL [https://raw.githubusercontent.com/AlexanderBierton/dotfiles/refs/heads/trunk/setup.sh](https://raw.githubusercontent.com/AlexanderBierton/dotfiles/refs/heads/trunk/setup.sh))"
```
